          ...
          @foreach($admin as $key => $user)
            ...
            <form action="{{url('/assign-roles')}}" method="POST">
              ...
              <tr>
                ...
                <td><input type="checkbox" name="add_role"  {{$user->hasRole('add') ? 'checked' : ''}}></td>
                <td><input type="checkbox" name="update_role"  {{$user->hasRole('update') ? 'checked' : ''}}></td>
                <td><input type="checkbox" name="view_role"  {{$user->hasRole('view') ? 'checked' : ''}}></td>

                <td><input type="checkbox" name="statistical_role"  {{$user->hasRole('statistical') ? 'checked' : ''}}></td>
                ...
                <td><input type="checkbox" name="coupon_role"  {{$user->hasRole('coupon') ? 'checked' : ''}}></td>

                <td><input type="checkbox" name="delivery_role"  {{$user->hasRole('delivery') ? 'checked' : ''}}></td>
