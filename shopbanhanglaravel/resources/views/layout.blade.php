...
<body>
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="logo pull-left">
                            <a style="color: white;" href="{{URL::to('/trang-chu')}}">
                    ...
                    <div class="col-xs-6">
                        ...
                        <form action="{{URL::to('/tim-kiem')}}" method="POST" >
                            ...
                            <input  id="message" style="width: 50%; color: black;" class="input-se" type="text" name="keywords_submit" placeholder="Tìm sản phẩm"  />

                            <button type="submit" class="btn-se">Tìm</button>
                            
                            <h4 class="btn btn-info" style="background-color:#2E64FE;border: none;" id='btnTalk'>
                                <i id="microphone" style="font-size: 25px;" class="fa fa-microphone hover-transform"></i>
                            </h4>
                        </form>   
    ...
    <script>
        ...
        recognition.onresult = function(event) {
            ...
            location.replace('search-voice/'+result9);
                                    ...
                                    @if(session::get('cart') == true)
                                        ...
                                        <td>
                                            <a href="{{URL::to('/chi-tiet')}}/{{$cart['product_slug']}}">
                                                ...
                                                <img  src="{{asset('public/uploads/product/'.$cart['product_image'])}}" width="50px" height="50px" alt="{{$cart['product_name']}}" />
                                            </a>
                                        </td>
    ...
    <section id="slider"><!--slider-->
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            <div class="item {{$i==1 ? 'active' : '' }}">
                                    ...
                                    <img alt="{{$slide->slider_MoTa}}" src="{{asset('public/uploads/slider/'.$slide->slider_Anh)}}"  class="img img-responsive img-slider" width="100%">
                ...
                <div class="col-xs-3">
                    <img src="{{url('/public/frontend/images/b1.png')}}" height="200" width="100%" alt="" />
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-xs-3">
                    <img src="{{url('/public/uploads/layout/one.jpg')}}" height="200" width="100%" alt="" />
                </div>
                <div class="col-xs-3">
                    <img src="{{url('/public/uploads/layout//vv.jpeg')}}" height="200" width="100%" alt="" />
                </div>
                <div class="col-xs-3">
                    <img src="{{url('/public/uploads/layout/q.png')}}" height="200" width="100%" alt="" />
                </div>
                <div class="col-xs-3">
                    <img src="{{url('/public/frontend/images/tt1.png')}}" height="200" width="100%" alt="" />
                </div>
