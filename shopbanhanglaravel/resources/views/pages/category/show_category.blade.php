                          ...
                          <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{URL::to('/danh-muc-sx/'.$slug_category_product,$od='ASC')}}"  >
                                            Giá tăng dần
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/danh-muc-sx/'.$slug_category_product,$od='DESC')}}"  >
                                            Giá giảm dần
                                        </a>
                                    </li>
...
<div class="features_items"><!--features_items-->
                       ...
                       <div class="fb-like" data-href="{{$url_canonical}}" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="false"></div> -->
                        ...
                        <h2 class="title text-center">{{$name->DanhMuc_Ten}}</h2>
