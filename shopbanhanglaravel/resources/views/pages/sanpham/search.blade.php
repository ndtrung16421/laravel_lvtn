                          ...
                          <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                        <!-- <a href="{{URL::to('/home-order/'.$od='ASC',$keywords)}}">
                                            Giá tăng dần
                                        </a> -->
                                        ...
                                        @csrf 
                                           ...
                                           <center> <button class="btn btn-success" type="submit" >Giá tăng dần</button></center>
                                    ...
                                    <br/>
                                    <li>
                                        <!-- <a href="{{URL::to('/home-order/'.$od='DESC',$keywords)}}">
                                            Giá giảm dần
                                        </a> -->
                                        <form action="{{URL::to('/search-order')}}" method="POST">
                                        @csrf 
                                            ...
                                            <center> <button class="btn btn-success" type="submit" >Giá giảm dần</button></center>
...
<div class="features_items"><!--features_items-->
                    @if($repl == 1)
                        <h2 class="title text-center">Không tìm thấy !!!"</h2>
                        <h2 class="title text-center">Kết quả thay thế cho : "{{$keywords}}"</h2>
                    @else
                    ...
                    @endif
                        ...
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                ...
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <input type="button" value="Thêm giỏ hàng" class="btn btn-default add-to-cart" data-id_product="{{$product->SanPham_id}}" name="add-to-cart">
                            ...
                            @endif
                                        ...
                                        <li></li>
                                        <li><input style="width: 80px;" id="number_1" type="number" min="1" value="1" class="cart_product_qty_{{$product->SanPham_id}}"></li>
                                    </ul>
                                    </form>
                                </div>
                            </div>
